data "aws_secretsmanager_secret" "secrets" {
  arn = "arn:aws:secretsmanager:eu-west-2:061683563079:secret:prod/rds/password-Ybewq3"
}
...
resource "aws_db_instance" "rds-db" {
  ...
  password               = data.aws_secretsmanager_secret_version.secretVers.secret_string
  port                   = 5432
